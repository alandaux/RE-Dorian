...
bird <- lat_lng(bird,coords=c("coords_coords"))
...
bird <- subset(bird, place_type == 'city'| place_type == 'neighborhood'| place_type == 'poi' | !is.na(lat))
...
bird <- lat_lng(bird,coords=c("bbox_coords"))
